...
namespace genesia::convnext {
    ...
    __global__ void dw_packed(compute::TensorView out, const __nv_bfloat162* x, const __nv_bfloat162* weight, const __nv_bfloat162* bias) {
...
#pragma unroll
    ...
    __global__ void dw_dx_kernel(compute::TensorView dx, compute::TensorView dy, const void* weight) {
...
#pragma unroll
    ...
    __global__ void dw_param_kernel(compute::TensorView dy, compute::TensorView x, float* dw, float* db) {
    ...
    void depthwise(cudaStream_t s, compute::TensorView o, compute::TensorView x, const void* w, const void* b) {
    ...
    void depthwise_backward(cudaStream_t s, compute::TensorView dx, compute::TensorView dy, compute::TensorView x, const void* w, float* dw, float* db, float*) {
