...
export module genesia.models.sdxl.workspace;
...
export namespace genesia::sdxl {
    struct Workspace final {
        compute::TensorView normalized;
        compute::TensorView hidden;
        compute::TensorView output;
        compute::TensorView shortcut;
        compute::TensorView combined;
        float* statistics;
    };
